...
@section('content')
    ...
    <div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__head">
            ...
            <form method="post" action="{{route('dashboard.product.store')}}" class="validate">
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="product_name" data-rule-required="true" placeholder="مثال : أجهزة كهربائية">
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" data-rule-required="true" data-rule-number="true" name="num_of_box"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" name="num_of_package_in_box" data-rule-required="true" data-rule-number="true"
                                   placeholder="مثال : 100">
                        </div>

                        <div class="col-lg-4">
                            <label>ادخل عدد القطع داخل كل رزمة</label>
                            <input type="text" class="form-control" name="num_of_Piece_in_package"  data-rule-required="true" data-rule-number="true"
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-shekel-sign"></i></span></div>
                                <input type="text" class="form-control" placeholder="العملة شيكل" data-rule-required="true" data-rule-number="true" name="price_by_package" aria-describedby="basic-addon1">
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-shekel-sign"></i></span></div>
                                <input type="text" class="form-control" name="price_by_piece"  data-rule-required="true" data-rule-number="true" placeholder="العملة شيكل">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" name="manufacturer"  data-rule-required="true"
